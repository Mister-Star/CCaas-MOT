...
size_t Table::SerializeSize()
{
    ...
    size_t ret =
        ...
        SerializablePOD<uint16_t>::SerializeSize(m_numIndexes) + SerializablePOD<uint32_t>::SerializeSize(m_tableId) +
...
void Table::DeserializeNameAndIds(const char* data, uint32_t& intId, uint64_t& extId, string& name, string& longName)
{
    uint16_t nIndexes;
