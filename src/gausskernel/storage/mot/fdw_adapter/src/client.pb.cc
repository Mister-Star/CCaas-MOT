...
static void InitDefaultsscc_info_ClientReadRequest_proto_2fclient_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ClientReadRequest_proto_2fclient_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_ClientReadRequest_proto_2fclient_2eproto}, {
      &scc_info_Row_proto_2ftransaction_2eproto.base,}};

static void InitDefaultsscc_info_ClientReadResponse_proto_2fclient_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ClientReadResponse_proto_2fclient_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_ClientReadResponse_proto_2fclient_2eproto}, {
      &scc_info_Row_proto_2ftransaction_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto_2fclient_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_proto_2fclient_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_proto_2fclient_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_proto_2fclient_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto_2fclient_2eproto_sccs[2] = {
  &scc_info_ClientReadRequest_proto_2fclient_2eproto.base,
  &scc_info_ClientReadResponse_proto_2fclient_2eproto.base,
};
...
static bool dynamic_init_dummy_proto_2fclient_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fclient_2eproto), true);
namespace proto {
...
void ClientReadRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ClientReadRequest_proto_2fclient_2eproto.base);
  client_ip_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void ClientReadResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ClientReadResponse_proto_2fclient_2eproto.base);
