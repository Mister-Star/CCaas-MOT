...
extern PROTOBUF_INTERNAL_EXPORT_proto_2fclient_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ClientReadRequest_proto_2fclient_2eproto;
...
static void InitDefaultsscc_info_Message_proto_2fmessage_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<8> scc_info_Message_proto_2fmessage_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 8, 0, InitDefaultsscc_info_Message_proto_2fmessage_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto_2fmessage_2eproto_sccs[1] = {
  &scc_info_Message_proto_2fmessage_2eproto.base,
};
...
static bool dynamic_init_dummy_proto_2fmessage_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fmessage_2eproto), true);
namespace proto {
...
void Message::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Message_proto_2fmessage_2eproto.base);
  clear_has_type();
}
