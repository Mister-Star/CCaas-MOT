...
class ReplyTransactionToClient :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_proto_2fserver_2eproto);
    return ::descriptor_table_proto_2fserver_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::proto::TxnState txn_status() const;
  void set_txn_status(::proto::TxnState value);
  private:
  ::proto::TxnState _internal_txn_status() const;
  void _internal_set_txn_status(::proto::TxnState value);
  public:
...
// .proto.TxnState txn_status = 2;
inline void ReplyTransactionToClient::clear_txn_status() {
  txn_status_ = 0;
}
inline ::proto::TxnState ReplyTransactionToClient::_internal_txn_status() const {
  return static_cast< ::proto::TxnState >(txn_status_);
}
inline ::proto::TxnState ReplyTransactionToClient::txn_status() const {
  // @@protoc_insertion_point(field_get:proto.ReplyTransactionToClient.txn_status)
  return _internal_txn_status();
}
inline void ReplyTransactionToClient::_internal_set_txn_status(::proto::TxnState value) {
