...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_storage_2eproto[2];
...
const char descriptor_table_protodef_storage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "v_node\030\006 \001(\0132\013.proto.Nodeb\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_storage_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_storage_2eproto = {
  &descriptor_table_storage_2eproto_initialized, descriptor_table_protodef_storage_2eproto, "storage.proto", 353,
  &descriptor_table_storage_2eproto_once, descriptor_table_storage_2eproto_sccs, descriptor_table_storage_2eproto_deps, 2, 2,
  schemas, file_default_instances, TableStruct_storage_2eproto::offsets,
  file_level_metadata_storage_2eproto, 2, file_level_enum_descriptors_storage_2eproto, file_level_service_descriptors_storage_2eproto,
};
