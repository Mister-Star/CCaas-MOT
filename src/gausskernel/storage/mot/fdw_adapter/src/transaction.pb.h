...
class Column :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_proto_2ftransaction_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::proto::TxnState Transaction::_internal_txn_status() const {
  return static_cast< ::proto::TxnState >(txn_status_);
}
inline ::proto::TxnState Transaction::txn_status() const {
  // @@protoc_insertion_point(field_get:proto.Transaction.txn_status)
  return _internal_txn_status();
}
inline void Transaction::_internal_set_txn_status(::proto::TxnState value) {
  
  txn_status_ = value;
}
inline void Transaction::set_txn_status(::proto::TxnState value) {
  _internal_set_txn_status(value);
  // @@protoc_insertion_point(field_set:proto.Transaction.txn_status)
}
